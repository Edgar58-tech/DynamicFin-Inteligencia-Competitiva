...
const Sidebar: React.FC<SidebarProps> = ({ currentView, onNavigate }) => {
  ...
  return (
    <div className="h-full w-full bg-white border-r border-gray-200 flex flex-col shadow-lg">
...
const Layout: React.FC<LayoutProps> = ({ children, currentView, onNavigate }) => {
  return (
    <div className="flex h-screen bg-gray-50 overflow-hidden">
      {/* Sidebar */}
      <aside className="w-64 flex-shrink-0 h-full hidden md:block">
      ...
      <div className="flex-1 flex flex-col overflow-hidden">
        {/* Header */}
        <header className="h-16 bg-white shadow-sm flex items-center justify-between px-6 flex-shrink-0 border-b border-gray-200">
