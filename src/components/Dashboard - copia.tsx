...
const Dashboard: React.FC = () => {
  ...
  return (
    <div className="w-full space-y-6">
      {/* Header Principal */}
      <div 
        className="relative bg-gradient-to-r from-indigo-700 via-purple-600 to-purple-700 text-white p-6 rounded-lg shadow-lg overflow-hidden"
      >
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        ...
        >
          <span className={activeSection === 'estrategico' ? 'text-white' : 'text-indigo-600'}>📈</span>
      ...
      {activeSection === 'estrategico' && (
        <div className="bg-white rounded-lg shadow-md p-8 text-center">
          <h2 className="text-2xl font-bold text-gray-800 mb-4">📈 Dashboard Estratégico</h2>
          <p className="text-gray-600">Vista estratégica de competencia y mercado</p>
          <div className="mt-6 bg-gradient-to-r from-blue-50 to-purple-50 p-6 rounded-lg">
            <p className="text-gray-700">Análisis estratégico de posicionamiento competitivo</p>
          </div>
        </div>
      )}
